...
function calc() {
  ...
  var calcTotal = function calculatingTotalAmount() {
  ...
  var setStat = function setStaticInformationFromLocalStorage(Selector, activeClass) {
  ...
  var getStat = function getStaticInformationFromCalculater(Selector, activeClass) {
    var elements = document.querySelectorAll(Selector);
    elements.forEach(function (element) {
  ...
  var getDinamic = function getDinamicInformationFromCalculaterInputs(selector) {
...
function forms(form) {
  ...
  messageForms.forEach(function (item) {
  ...
  function showThanksModal(message) {
    ...
    var greetModalDialog = document.createElement('div');
    greetModalDialog.classList.add('.modal__dialog');
    var modal = document.querySelector('.modal');
    prevModalDialog.classList.add('hide');
    (0,_modal__WEBPACK_IMPORTED_MODULE_8__.removeHideModalWindow)('.modal');
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_8__.setHideModalWindow)('.modal');
    }, 4000);
  }
}
...
function items() {
  var MenuItems = /*#__PURE__*/function () {
    function MenuItems(item, src, alt, subtitle, description, price) {
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getItems)('http://localhost:3000/menu').then(function (data) {
...
/* harmony export */   "setHideModalWindow": function() { return /* binding */ setHideModalWindow; },
/* harmony export */   "removeHideModalWindow": function() { return /* binding */ removeHideModalWindow; }
/* harmony export */ });
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.for-each */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
function modal(triggerSelector, modalSelector) {
  ...
  var modalWindowDelay = setTimeout(function () {
    return removeHideModalWindow(modalSelector);
  }, 5000);
...
function slider(_ref) {
  ...
  if (slides.length < 10) {
    totalSlidesAmount.textContent = "0".concat(slides.length);
    currentSlideIndex.textContent = "0".concat(slideIndex);
  } else {
    currentSlideIndex.textContent = "".concat(slideIndex);
    totalSlidesAmount.textContent = "".concat(slides.length);
  }

  var addZero = function addZeroDepenceOnNumberRank() {
    if (slideIndex < 10) {
      currentSlideIndex.textContent = "0".concat(slideIndex);
    } else {
      currentSlideIndex.textContent = "".concat(slideIndex);
  ...
  var refreshDots = function refreshArrayOfDots() {
  ...
  innerSlideBlock.style.width = "".concat(100 * slides.length, "%");
  ...
  for (var i = 0; i < slides.length; i++) {
    var itemDotList = document.createElement('li');
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      ...
      innerSlideBlock.style.transform = "translateX(-".concat(offset, "px)");
      addZero();
      refreshDots();
    });
  });
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  var tabContents = document.querySelectorAll(tabsSelector);
  var tabParent = document.querySelector(tabsContentSelector);
  var tabs = document.querySelectorAll(tabsParentSelector);
  ...
  function showTab() {
    var tabItem = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
function timer(id, deadLine) {
  function getTimeRemaining(endtime) {
    var conclusionDate = Date.parse(endtime) - Date.parse(new Date()),
